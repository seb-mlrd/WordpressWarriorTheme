...
<div class="background_button_4">
    <div class="buttons_photo_4">
        <div class="button_photo_left_4">
            <p><i class="arrow_photo_4 arrow_photo_left_4"></i></p>
        </div>
        <div class="button_photo_right_4">
            <p><i class="arrow_photo_4 arrow_photo_right_4"></i></p>
        </div>
    </div>
</div>
